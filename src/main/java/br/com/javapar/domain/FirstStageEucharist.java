...
@Entity
public class FirstStageEucharist extends GenericDomain
{
	...
	public FirstStageEucharist()
	{
		
	}

	public FirstStageEucharist(CatechesisPerson adultCatechesis, String weekday, 
