...
@Entity
public class ThirdStageEucharist extends GenericDomain
{
	...
	public ThirdStageEucharist()
	{
		
	}

	public ThirdStageEucharist(CatechesisPerson adultCatechesis, String weekday, 
