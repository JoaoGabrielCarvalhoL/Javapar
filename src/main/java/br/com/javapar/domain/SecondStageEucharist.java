...
@Entity
public class SecondStageEucharist extends GenericDomain
{
	...
	public SecondStageEucharist()
	{
		
	}

	public SecondStageEucharist(CatechesisPerson adultCatechesis, String weekday, 
	...
	public String toString() {
		return "SecondStageEucharist [adultCatechesis=" + adultCatechesis + 
