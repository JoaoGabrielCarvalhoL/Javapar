...
@Entity
public class FirstStageConfirmation extends GenericDomain
{
	...
	public FirstStageConfirmation()
	{
		
	}

	public FirstStageConfirmation(CatechesisPerson adultCatechesis, String weekday, 
